...
public class NotExistErrorResponse extends ErrorResponse {
	 ...
	 *            本地化对象
	 * @param params
	 *            错误信息的参数，如错误消息的值为:use '{0}'({1})can't find '{2}' object
	...
	public NotExistErrorResponse(String objectName, String queryFieldName, Object queryFieldValue, Locale locale) {
		...
		SubError subError = SubErrors.getSubError(subErrorCode, SubErrorType.ISV_NOT_EXIST.value(), locale, queryFieldName, queryFieldValue, objectName);
